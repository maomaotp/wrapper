...
contract WrapperFON is IERC20, Ownable {
    ...
    constructor() {
        _wrapped = ERC20(0x12a055D95855b4Ec2cd70C1A5EaDb1ED43eaeF65);
        _name = _wrapped.name();
        _symbol = _wrapped.symbol();
        ...
        _mint(0x09b5e849f2cd57c977D31f66be045B6D60605277, 1000000 * 10**uint(decimals()));
    }
